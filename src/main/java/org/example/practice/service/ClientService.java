...
public class ClientService{
    ...
    @Autowired
    private UpdateRepository<Client> clientUpdateRepository;
    @Autowired
    private UpdateRepository<LoyaltyCard> loyaltyCardUpdateRepository;
    @Autowired
    private ReadRepository<Client> clientReadRepository;
